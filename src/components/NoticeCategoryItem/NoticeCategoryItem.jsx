...
import { addToFavorite, removeFromFavorite } from 'redux/notices/noticesOperations';
...
const NoticeCategoryItem = ({ notice }) => {
  ...
  return (
    ...
    <ImageContainer>
      ...
      <LoadMoreBtn type="button" onClick={handleOpen}>Learn more <PawStyled/></LoadMoreBtn>
      ...
      >
          <ModalBox >
            ...
            <ModalCloseBtn><ModalCloseBtnIcon onClick={handleClose}/></ModalCloseBtn>
